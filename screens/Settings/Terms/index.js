    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ marginTop: headerHeight }}>
          ...
          <Text>
            By accessing this Website, accessible from www.EventDropapp.co, you are
          ...
          <Text>
            ...
            materials on EventDrop App's Website for personal, non-commercial
          ...
          <Text>
            This will let EventDrop App to terminate upon violations of any of
          ...
          <Text>
            All the materials on EventDrop App’s Website are provided "as is".
            EventDrop App makes no warranties, may it be expressed or implied,
            therefore negates all other warranties. Furthermore, EventDrop App does
          ...
          <Text>
            EventDrop App or its suppliers will not be hold accountable for any
            damages that will arise with the use or inability to use the
            materials on EventDrop App’s Website, even if EventDrop App or an
          ...
          <Text>
            The materials appearing on EventDrop App’s Website may include
            technical, typographical, or photographic errors. EventDrop App will
            not promise that any of the materials in this Website are accurate,
            complete, or current. EventDrop App may change the materials contained
            on its Website at any time without notice. EventDrop App does not make
            any commitment to update the materials.
          </Text>
          <Text style={styles.subtitle}>6. Links</Text>

          <Text>
            EventDrop App has not reviewed all of the sites linked to its Website
            and is not responsible for the contents of any such linked site. The
            presence of any link does not imply endorsement by EventDrop App of the
          ...
          <Text>
            EventDrop App may revise these Terms of Use for its Website at any time
          ...
          <Text>
            Any claim related to EventDrop App's Website shall be governed by the
